...
echo "$($PSQL "SELECT distinct(t.name) FROM teams AS t FULL JOIN games AS g ON g.winner_id=t.team_id FULL JOIN games AS gg ON gg.opponent_id=t.team_id WHERE (g.round='Eighth-Final' OR gg.round='Eighth-Final') AND (g.year=2014 Or gg.year=2014);")"
